...
map("n", "<leader>rnu", "<cmd>set rnu!<CR>", { desc = "toggle relative number" })
...
map("n", "\\", ":vsp<CR>", { desc = "split vertically" })
map("n", "|", ":sp<CR>", { desc = "split horizontally" })
map("n", "sc", "<C-w>c", { desc = "close window" })
map("n", "so", "<C-w>o", { desc = "close other windows" })
map("n", "s,", ":vertical resize -10<CR>", { desc = "decrease window width" })
map("n", "s.", ":vertical resize +10<CR>", { desc = "increase window width" })
map("n", "sj", ":horizontal resize -10<CR>", { desc = "decrease window height" })
map("n", "sk", ":horizontal resize +10<CR>", { desc = "increase window height" })
...
map({ "n", "t" }, "<leader>tf", function()
    require("nvchad.term").toggle { pos = "float", id = "floatTerm", width = 0.8 }
