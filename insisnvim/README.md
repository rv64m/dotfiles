...
InsisVim has the following built-in plugins, which will be enabled when you enable this option:

- [copilot.lua](https://github.com/zbirenbaum/copilot.lua)
- [copilot-cmp](https://github.com/zbirenbaum/copilot-cmp)

Because Copilot is a paid service, you need to run `:Copilot auth` to authenticate it the first time you use it. However, if you are a student, teacher, or open source project contributor, you can [apply for free use](https://docs.github.com/en/copilot/quickstart).
...
InsisVim has [Codeium.nvim](https://github.com/Exafunction/codeium.nvim) built-in, which will be enabled when you enable this option.

You will need to run `:Codeium Auth` to authenticate it the first time you use it.
